package com.example.jessie.dietchartapp.chatbot;
...
import com.example.jessie.dietchartapp.R;
...
//        initChatbot();
    ...
    private void initChatbot() {
        final AIConfiguration config = new AIConfiguration("236bacbc7cc74d2f8eef320bf2972417",
...
//            requestTask.execute(aiRequest);
    ...
    private void showTextView(String message, int type) {
        ...
        TextView tv = (TextView) layout.findViewById(R.id.chatMsg);
        tv.setText(message);
        layout.requestFocus();
