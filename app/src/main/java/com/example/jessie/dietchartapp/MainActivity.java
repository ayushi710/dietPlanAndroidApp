...
public class MainActivity extends AppCompatActivity {
    ...
    Button bcalculate, bclear,bdietplan,bchatBot;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bchatBot = (Button)findViewById(R.id.button4);
        ...
        bchatBot.setVisibility(INVISIBLE);
            ...
            public void onClick(View v) {
                ...
                if (eWeight.length() == 0||eHeight.length()==0 ||eAge.length()==0||activityrate.length()==0) {
                    ...
                    if(eInches.length()==0)
                    {
                        ...
                        bchatBot.setVisibility(VISIBLE);
                    }
                    else
                    {
                        weight = Float.parseFloat(eWeight.getText().toString());
        ...
        bchatBot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent t1 = new Intent(MainActivity.this, com.example.jessie.dietchartapp.chatbot.MainActivity.class);
                startActivity(t1);
            }
        });
    }
